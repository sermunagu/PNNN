Sparse / phase-normalized NN workflow
=====================================
...
- main.m: flujo histórico monolítico de un experimento.
- main_bucle.m: flujo histórico de barrido de activaciones y arquitecturas.
...
- x es la entrada física del bloque modelado e y su salida.
