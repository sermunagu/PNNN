...
performanceTable = table(Description, Measurement, MappingMode, Modelado, ...
    ...
    PruningEnabled, PruningTargetMode, PruningScope, PruningIncludeBiases, ...
    PruningFreezePruned, SparsityTarget_pct, SparsityActual_pct, ...
    TargetActiveTrainableParams, TargetActivePrunableParams, ...
    ActualActiveTrainableParams, ActiveWeightParams, ActiveBiasParams, ...
    ...
    PAPR_Test_Ref_dB, EVM_TrainVal_pct, EVM_TrainVal_dB, EVM_Test_pct, ...
    EVM_Test_dB, ACPR_Test_Pred_Left2_dB, ACPR_Test_Pred_Left1_dB, ...
