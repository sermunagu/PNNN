...
headers = {'Measurement', 'Target mode', 'Scope', 'Include biases', ...
    'Sparsity target (%)', 'Effective sparsity (%)', ...
    'Target active params', 'Actual active params', 'Active weights', ...
    'Active biases', 'Protected params', 'Total trainable', ...
    'Total prunable', 'NMSE Ident. (Train+Val)', ...
