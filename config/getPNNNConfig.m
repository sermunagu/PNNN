...
cfg.pruning.targetMode = 'activeTrainableParams'; % 'sparsity' or 'activeTrainableParams'
cfg.pruning.targetActiveTrainableParams = [];
cfg.pruning.scope = "global";
cfg.pruning.includeBiases = false;
cfg.pruning.structureMode = "unstructured"; % 'unstructured', 'inputFeature', 'memoryTap', 'nonlinearOrder', or 'tapOrder'
cfg.pruning.structuredRanking = "magnitude"; % L1 magnitude ranking for structured groups.
...
cfg.sweep.targetActiveParamList = [800 1000 1200 1400];
...
cfg.sweep.iterativeStepSize = 0.1;
cfg.sweep.iterativeFineTuneEpochs = cfg.pruning.fineTuneEpochs;
cfg.sweep.iterativeOutputRoot = fullfile(cfg.paths.resultsDir, 'pruning_sweeps');
cfg.sweep.layerwiseOutputRoot = fullfile(cfg.paths.resultsDir, 'pruning_sweeps');
